...
import run.RunAllSamples;
 ...
 /**
 * Sample      : SaveAsProgram
 * Category    : BusinessObject webservice
 *
 * Description : This sample demonstrates the usage of 'SaveAsObject' webservice
 * for a specific case where one Agile program object is saved as another. 
 * The request object contains a few additional specifications in this case, these
 * are specific to a program object.
 */
public class SaveAsProgram {
    private static final String COMMAND_NAME = "SaveAsProgram";
