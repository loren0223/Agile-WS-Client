 ...
 */
public class CreateObjectAPIName {
    private static final String COMMAND_NAME = "CreateObjectAPIName";
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Executing webservice sample: ");
         ...
         try {
             ...
             System.out.println("Creating a document '" + documentNumber + "' and part '" + partNumber + "' using API names...\n");
             ...
             el_number.setTextContent(documentNumber);
             Element el_description = WSUtil.createMessageElement("description");
             el_description.setTextContent("Doc Desc");
             ...
             el_number = WSUtil.createMessageElement("number");
             el_number.setTextContent(partNumber);
