 ...
 * to retrieve a Manufacturer Part. The request object contains the 
 * specifications that identify the Agile object along with the option 
 * 'manufacturer_name' which is specially used in this case. The response contains
 * message elements that represent information about the Agile object. 
 */
public class getManufacturerPart {
    private static final String COMMAND_NAME = "getManufacturerPart";
    ...
    public static void main(String args[]){     
        ...
        System.out.println("Executing webservice sample: ");
         ...
         try {
             ...
             System.out.println("Retrieving the manufacturer part '" + manufPartNumber + "'...\n");                                       
             ...
             tableRequests[0].setTableIdentifier( ManufacturerPartConstants.TABLE_ATTACHMENTS.toString() );
