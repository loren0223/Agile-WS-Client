 ...
 * to retrieve an Agile Business object. The request object contains the 
 * specifications that identify the Agile object and the response contains
 * message elements that represent information about the Agile object. 
 */
public class GetObject{
    private static final String COMMAND_NAME = "GetObject";
...
public static void displayMessageElementValue(Element element){
    ...
    public static void main(String args[]){	
        ...
        System.out.println("Executing webservice sample: ");
          ...
          *    to retrive a particular Agile Object
          */	
