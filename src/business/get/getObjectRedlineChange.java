 ...
 * to retrieve a particular version of  an Agile Object using its change number
 * as a reference. The request object contains the specifications that identify 
 * the Agile object along with the option 'redline_change' which is specially
 * used in this case. The response contains message elements that represent
 * information about the Agile object retrieved. 
 */
public class getObjectRedlineChange {
    private static final String COMMAND_NAME = "getObjectRedlineChange";
    ...
    public static void main(String args[]){     
        ...
        System.out.println("Executing webservice sample: ");
         ...
         try {
             ...
             System.out.println("Retrieving object '" + partNumber + "', change: " + changeNumber + "...\n");                          
