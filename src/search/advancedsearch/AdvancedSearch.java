...
public class AdvancedSearch {
    private static final String COMMAND_NAME = "AdvancedSearch";
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            // Advanced search also provides for other options such as usage of 
            // parameters as a part of the query, specification of search type,
            // visibility level and usage of attributes.
            // These variations of the advanced search webservice are explored 
            // in the other advanced search samples accompanying this collection of 
            // search webservice samples.
