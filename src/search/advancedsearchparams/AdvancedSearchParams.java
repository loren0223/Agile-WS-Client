package search.advancedsearchparams;
...
/**
* Sample      : AdvancedSearchParams
* Category    : Search webservice
*
* Description : This sample demonstrates the execution of an advanced search
* along with parameters that will be substituded into the search criterion. 
* The fields necessary for the advanced search are specified through the request
* object and the search results are obtained in the response object.
*/
public class AdvancedSearchParams {
    private static final String COMMAND_NAME = "AdvancedSearchParams";
    ...
    public static String attr_partCategory = "itemCategory";
    ...
    public static void prepareData(String[] args){
        ...
        try{
            ...
            String partNumber = dataPrepare.getNextAutoNumber("Part");
            dataPrepare.createObjectByTags("Part",
                                           new String[]{attr_number, attr_description, attr_partCategory},
                                           new String[]{ partNumber, "Desc", "Mechanical" },
                                           new String[]{"String","String","AgileListEntryType"} );
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            // %0, %1 and so on.
            ParamListType params[] = new ParamListType[2];
            for(int i=0; i<params.length; i++)
                params[i] = new ParamListType();
            
            params[0].getParameter().add("P0");
            params[1].getParameter().add("Electrical");
            ...
            // characters 'P0' and all parts that do not belong to the category
            // of 'Electrical'. The parametric values denoted by %0, %1 are 
            // obtained from the parameters that were previously declared 
            // in the request object.            

            
            String criteria = "[Title Block.Number] starts with %0 && " +
                              "[Title Block.Part Category] is not null && " +
                              "[Title Block.Part Category] not in %1";
            ...
            String attribute4 = "Title Block.Part Category";
            ...
            advancedSearchRequestType.getResultAttributes().add(attribute4);
