 ...
 */
public class ClearAffectedItemsTable {
    ...
    public ClearAffectedItemsTable() {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            AgileClearTableRequestType agileClearTableRequestType[] = new AgileClearTableRequestType[1];             
            ...
            agileClearTableRequestType[0].setAgileTable(table2);
             ...
             */
            clearTableRequestType.setDisableAllWarnings(true);
            /*
             * 
             */
            ...
            if( !clearTableResponseType.getStatusCode().toString().equals( ResponseStatusCode.SUCCESS.value() ) ){
                ...
                AgileWarningListType[] agileWarningListType = clearTableResponseType.getWarnings().toArray(new AgileWarningListType[0]);
