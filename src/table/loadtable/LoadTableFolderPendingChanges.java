 ...
 */
public class LoadTableFolderPendingChanges {
    private static final String COMMAND_NAME = "LoadTableFolderPendingChanges";
    ...
    public LoadTableFolderPendingChanges() {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            table[0].setTableIdentifier( FileFolderConstants.TABLE_PENDINGCHANGES.toString() );
            
            System.out.println("Loading Pending Changes table of the file folder '" + folderNumber + "'...\n");
	...
	public static void displayTableContents(AgileTableType[] tables) {
		if (tables != null) {
			for (int i = 0; i < tables.length; i++) {
				...
				String tableName = tables[i].getTableIdentifier()
						.getTableDisplayName();
				if (tableName != null)
