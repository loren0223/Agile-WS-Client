 ...
 */
public class LoadTableRedlineChange {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            System.out.println("Loading the title block page of part '" + partNumber + "''s change '" + changeNumber + "'...\n");
