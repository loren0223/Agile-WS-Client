...
import run.RunAllSamples;
 ...
 /**
 * Sample      : LoadTableRedlineChange
 * Category    : Table webservice
 *
 * Description : This sample demonstrates the process of loading the content
 * of a table from a particular version of an Agile object. The request
 * object consists of specifications identifying the table and the file folder
 * along with an option 'redline_change', which refers to the change object 
 * associated with that version of the Agile object. The response object consists
 * of the rows of that table, with row content available as message elements.
 */
public class LoadTableBOMRedlineChange {
    private static final String COMMAND_NAME = "LoadTableRedlineChange";
    ...
    public LoadTableBOMRedlineChange() {
    ...
    public static void prepareData(String[] args){
        ...
        try{
            ...
            dataPrepare.updateObjectPendingChange(partNumber, changeNumber,
                                                  "description", "Updated value of Desc Version 2");            
            
            dataPrepare.changeStatusToReleased( changeNumber, partNumber);
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            table[0].setClassIdentifier( "Parts" );
            table[0].setObjectNumber( partNumber );
            table[0].setTableIdentifier( "-803" );
            ...
            System.out.println("Loading the redline bom of part '" + partNumber + "''s change '" + changeNumber + "'...\n");
