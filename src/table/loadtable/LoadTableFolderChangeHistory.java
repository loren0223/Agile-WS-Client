 ...
 */
public class LoadTableFolderChangeHistory {
    private static final String COMMAND_NAME = "LoadTableFolderChangeHistory";
    ...
    public LoadTableFolderChangeHistory() {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            table[0].setTableIdentifier( FileFolderConstants.TABLE_CHANGEHISTORY.toString() );
            
            System.out.println("Loading Change History table of the file folder '" + folderNumber + "'...\n");
