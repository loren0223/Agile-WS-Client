 ...
 * along with an option 'revision', which refers to version number of the Agile
 * object. The response object consists of the rows of that table, with row
 * content available as message elements.
 */
public class LoadTableRevision {
    private static final String COMMAND_NAME = "LoadTableRevision";
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            properties[0].setPropertyName( SchemaConstants.REVISION.value() );
            properties[0].setPropertyValue( partVersion );
            table[0].getOptions().addAll(Arrays.asList(properties));
            
            System.out.println("Loading the title block page of version " + partVersion + " of part '" + partNumber + "'...\n");
