...
import common.util.WSUtil;
 ...
 /**
* Sample      : GetFileAttachment
* Type        : Attachment webservice 
* 
* Description : This sample demonstrates the usage of 'getFileAttachment' webservice
* which is used to retrieve the contents of a file attachment from an Agile object.
...
public class GetFileAttachment {
    private static final String COMMAND_NAME = "GetFileAttachment";
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            // rowId. This is applicable in a case when the file queried for is present
            // in a single and separate row. In other cases, when there are several files
            // in the same row and the desired file is one of them, the fileId must also
            // be specified. Such an example is outlined in another sample program.
            ...
            attachments.setRowId( getRowOrFileId(fileName, 
