...
* of its rowId in the attachment tab and its fileId. This is applicable in cases
* when multiple files are associated with a single row.
*/
public class GetFileAttachmentFileIds {
    private static final String COMMAND_NAME = "GetFileAttachmentFileIds";
    ...
    public GetFileAttachmentFileIds() {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            System.out.println("by using a fileId, in the case of multiple files bound to a single row or folder.\n");
            ...
            // In this sample a file is downloaded from the attachment tab using its
            // fileId along with the rowId. This is applicable in a case when there are
            // several files in the same row and the desired file is one of them. 
            // Using the rowId alone in this case is ineffective since all the files of that
            // row will be obtained. To download only a specific file from such a set of
            // files in a single row, the fileId is also needed. Set the rowId information
            // as usual, then obtain the fileId value and set the same into the
            // 'files' element of the request object.
