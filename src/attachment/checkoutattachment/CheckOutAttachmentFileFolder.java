...
import common.util.WSUtil;
 ...
 /**
 * Sample      : CheckOutAttachmentFileFolder  
 ...
 * with the rowId of the attachment in the files tab of the file folder with which
 * it is associated. This is applicable in the case of multiple files associated
 * with a single row.
 */
public class CheckOutAttachmentFileFolder {
    private static final String COMMAND_NAME = "CheckOutAttachmentFileFolder";
    ...
    public CheckOutAttachmentFileFolder() {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            // In this sample, instead of using the fileId for checking out a file from
            // a row with multiple files, we may also use the rowId of the files tab in
            // the filefolder object vis-a-vis the  file under question. 
