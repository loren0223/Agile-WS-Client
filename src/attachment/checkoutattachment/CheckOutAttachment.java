...
/**
* Sample      : CheckOutAttachment  
* Type        : Attachment webservice 
* 
* Description : This sample demonstrates the usage of 'checkOutAttachment' webservice.
* The sample 'checks out' a file attachment of an Agile object, releasing the attachment
* for modifications.
*/
public class CheckOutAttachment {
    private static final String COMMAND_NAME = "CheckOutAttachment";
    ...
    //public static String SERVER_URL   =  cmdArgs[0] + "/" + serviceName;
    //public static String SERVER_URL_TABLE =  cmdArgs[0] + "/" + serviceName_2;
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            // Set the rowId of the file that has to be checked out.
