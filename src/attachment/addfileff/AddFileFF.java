...
* 
* Description : This sample demonstrates addition of a file to an 
* Agile File Folder. The file will be added to the 'Files' tab of 
* the file folder.
*/
public class AddFileFF {
    ...
    private static final String COMMAND_NAME = "AddFileFF";
