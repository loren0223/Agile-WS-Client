 ...
 * response object.
 */
public class GetFileFFAllFiles {
    ...
    public static void prepareData(){
        ...
        try{
            ...
            for(int i=0; i<fileName.length; i++)
                fileName[i] = folderNumber + "_File12" + (i+1) + ".txt";
            dataPrepare.checkOutFolder(folderNumber);
            dataPrepare.addAttachmentToFolder(folderNumber, new String[] {fileName[0]} );
            dataPrepare.addAttachmentToFolder(folderNumber, new String[] {fileName[1]} );
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            // from which files will be retrieved. In this sample all the files in 
            // a particular folder will be retrieved by using the 'allFiles' element.

            agileGetFileFFRequest.setFolderNumber(folderNumber);
            System.out.println("Retrieving all file from the file folder '" + folderNumber + "'...\n");
            
            // Set the boolean element 'allFiles' to true to obtain all the files
            // in the specific version of the folder requested for.
            agileGetFileFFRequest.setAllFiles(true);
            ...
            System.out.println("\nSTATUS CODE: " +  getFileFFResponseType.getStatusCode() );
                ...
                String statusCode = getFileFFResponseType.getStatusCode().toString();
                if( statusCode.equals("SUCCESS") || statusCode.equals("SUCCESS_WITH_WARNINGS") ){
                    // If the webservice call was successful, then display information about the file(s) retrieved.
                        ...
                        for(int i=0; i<responses.length; i++){
                            ...
                            System.out.println("\nThe following files were retrieved from " + responses[i].getFolderNumber() + ": ");
