...
* for a specific case where a file attachment is downloaded from a particular
* version of an Agile file folder object. The request object contains the
* specifications that identify the attachment to be downloaded and the version
* of the folder, an array of bytes is obtained in the response object. 
*/
public class GetFileFFFileVersion {
    ...
    public static void prepareData(){
        ...
        try{
            ...
            folderVersion = dataPrepare.getValueFromTable("FileFolder", folderNumber, FileFolderConstants.TABLE_TITLEBLOCK.toString(), "version").toString();
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            agileGetFileFFRequest = new AgileGetFileFFRequest();
            ...
            agileGetFileFFRequest.setFolderVersion( Integer.parseInt(folderVersion) );

            System.out.println("Retrieving a file from the file folder '" + folderNumber + "', version: " + folderVersion + "\n");            
