...
/**
* Sample      : AddFileAttachmentSingleFolder  
* Type        : Attachment webservice 
* 
* Description : This sample demonstrates the addition of several 
* file attachments to an Agile object with the additional specification
* that all the files added to the Agile object must be added to a
* single folder. 
*/
public class AddFileAttachmentSingleFolder {
    private static final String COMMAND_NAME = "AddFileAttachmentSingleFolder";
    ...
    public AddFileAttachmentSingleFolder() {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            System.out.println("Adding attachments to a single folder of '" + partNumber + "'...");
            ...
            // Two attachments are defined by specifying their prime attributes.                        
            ...
            // The element 'singleFolder' is used to signify that all the attachments added
            // to the object must be added under a single folder.
