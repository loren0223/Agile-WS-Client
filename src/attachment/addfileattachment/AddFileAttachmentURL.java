...
import com.agile.ws.schema.attachment.v1.jaxws.AgileAddFileAttachmentUrlRequestType;
...
/**
* Sample      : AddFileAttachmentURL  
* Type        : Attachment webservice 
* 
* Description : This sample demonstrates the addition of a URL attachment
* to the attachment tab of an Agile object.
*/
public class AddFileAttachmentURL {
    private static final String COMMAND_NAME = "AddFileAttachmentURL";
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            System.out.println("Adding a URL attachment to the part '" + partNumber + "'...");            
            
            // In this sample, a URL is added as an attachment to an Object. 
            // To achieve this, the element  '' is set with appropriate information.
            // The other elements need not be used in the request object.
            AgileAddFileAttachmentUrlRequestType url_attachments = new AgileAddFileAttachmentUrlRequestType();                                        
            url_attachments = new AgileAddFileAttachmentUrlRequestType();                
            url_attachments.setUrl("http://www.testurl.com");
            url_attachments.setDescription("Description for a test url");
            
            agileAddFileAttachmentRequest.getAttachmentUrls().add(url_attachments);
